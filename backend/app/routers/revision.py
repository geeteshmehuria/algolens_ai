...
from app.models import RevisionQueue, DSAProblem
...
def get_revision_queue(
    ...
    statement = select(RevisionQueue).where(
...
def complete_revision(
    ...
    schedule_revision(session, current_user.id, revision.problem_id, reason="Spaced repetition")
    session.commit()
