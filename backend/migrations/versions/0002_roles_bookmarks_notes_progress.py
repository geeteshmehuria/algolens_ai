...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("problem_id", sa.Integer(), sa.ForeignKey("dsa_problems.id"), nullable=False),
    ...
    op.create_index(op.f("ix_user_problem_progress_user_id"), "user_problem_progress", ["user_id"])
